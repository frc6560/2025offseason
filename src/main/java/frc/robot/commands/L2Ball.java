...
public class L2Ball extends SequentialCommandGroup {
    private final Elevator elevator;
    private final Arm arm;
    private final BallGrabber ballGrabber;

    public L2Ball(Elevator elevator, Arm arm, BallGrabber ballGrabber) {
    ...
    public Command actuateCommand() {
        return new ParallelCommandGroup(
            ...
            new RunCommand(() -> getElevatorToL2()),
    ...
    public Command getElevatorToL2() {
        return new RunCommand(() -> elevator.setGoal(ElevatorConstants.L2BALL));
    }

    public Command getArmToReefAngle() {
        return new RunCommand(() -> arm.setGoal(ArmConstants.REEF_POSITION_DEG_low));
    }
